  ...
  kofiWidgetOverlay.draw('yossi1113', {
    ...
    'floating-chat.donateButton.text-color': '#fff'
        ...
        <div>
            <div class="center">
                <div class="box">
                    &emsp;meとyourミスったら悲惨な模様<br>
                    &emsp;誤：what time do you Brush my teeth?<br>
                    &emsp;(いつ私の歯磨いてくれるの)<br>
						  &emsp;<br>
						  &emsp;正：what time do you Brush your teeth?<br>
						  &emsp;(いつあなたの歯磨くの)<br>
    ...
    <script>
        pdbb = "";
        fetch("https://raw.githubusercontent.com/yoshihisa11132/phpTube/refs/heads/main/passend.json").then(r => r.text()).then(r => JSON.parse(r)).then(r => {pdbb = r["key"];});
        let d = document;
